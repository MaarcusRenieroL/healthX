        ...
        <section className="">a
            <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
                <form className="w-full max-w-md">
                    <h1 className="mt-3 text-2xl font-semibold text-gray-800 capitalize mobile-large-screen:text-3xl text-center">Sign
                        Up</h1>
                    ...
                    <div className="mt-6">
                        ...
                        <a href="#"
                           className="flex items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:text-gray-200 bg-blue-500 hover:bg-blue-400">
