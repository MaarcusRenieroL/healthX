        ...
        <>
            ...
            <div className="p-7 w-screen">
                <div className="grid grid-rows-4">
                    <div className="grid 4k-screen:grid-cols-6 laptop-large-screen:grid-cols-4 tablet-screen:grid-cols-1 items-center justify-center">
                        <InsuranceCard
                            title="PM - JAY"
                        ...
                        <InsuranceCard
                            ...
                            imgSrc="https://yt3.ggpht.com/ytc/AMLnZu95hzIif4T65gulwa-_qZJtjtNYspmZS_sFOncDAw=s900-c-k-c0x00ffffff-no-rj"
                        />
                        <InsuranceCard
                            title="LIC"
                            link="https://uiic.co.in/en/product/health/Family-Medicare-2014"
                            imgSrc="https://pbs.twimg.com/profile_images/1242063307676106752/weyFDNzG_400x400.jpg"
                        />
                        <InsuranceCard
                            title="NEW INDIA"
                            link="https://www.newindia.co.in/portal/product/knowMore"
                            imgSrc="https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/New_India_Assurance.svg/1200px-New_India_Assurance.svg.png"
                        />
                        <InsuranceCard
                            title="UNITED INDIA"
                            link="https://uiic.co.in/en/product/health/Family-Medicare-2014"
